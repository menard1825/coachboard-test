...
def delete_game(game_id):
    ...
    if game_to_delete:
        # Find and delete all associated rotations
        rotations_to_delete = db.session.query(Rotation).filter_by(associated_game_id=game_id, team_id=session['team_id']).all()
