...
# Database URL
DATABASE_FILE = 'app_old.db'
OUTPUT_JSON_FILE = 'data_backup_from_db.json'

def export_data_to_json_direct_sqlite():
    if not os.path.exists(DATABASE_FILE):
        print(f"Error: Database file '{DATABASE_FILE}' not found. Please ensure your backup is named 'app_old.db' and is in the same directory.")
        return
    ...
    try:
        ...
        final_export_data = {
            ...
            "pitching": data.get("pitching_outings", []),
