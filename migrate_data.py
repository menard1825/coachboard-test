...
try:
    ...
    try:
        ...
        print(f"Error processing lineups: {e}")
        raise
    ...
    try:
        ...
        print(f"Error processing pitching outings: {e}")
        raise
    ...
    try:
        ...
        print(f"Error processing scouted players: {e}")
        raise
    ...
    try:
        ...
        print(f"Error processing rotations: {e}")
        raise
    ...
    try:
        ...
        print(f"Error processing collaboration notes: {e}")
        raise
    ...
    try:
        ...
        print(f"Error processing practice plans: {e}")
        raise
    ...
    try:
        ...
        print(f"Error processing player development focuses: {e}")
        raise
    ...
    try:
        ...
        print(f"Error processing signs: {e}")
        raise
