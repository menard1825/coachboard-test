...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderScoutingList() {
        ...
        const anchor = (window.location.hash || '#scouting').substring(1);
