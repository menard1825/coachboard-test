            ...
            <div class="col-12 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted mt-3">* "Innings Played by Position" reflects the total number of innings a player was assigned to each position across all game rotations.</p>
                    </div>
                </div>
            </div>`;
