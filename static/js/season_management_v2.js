(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      #rotations .defense-preset-home{border:1px solid #dce5dc;border-radius:13px;background:#f8fbf8;margin-bottom:14px;overflow:hidden}#rotations .dph-head{padding:11px 13px;border-bottom:1px solid #e3e9e3;display:flex;justify-content:space-between;gap:10px;align-items:center}#rotations .dph-head strong{font-size:.82rem;color:#172033}#rotations .dph-head span{font-size:var(--cb-text-xs);color:#667085}#rotations .dph-head-actions{display:flex;align-items:center;gap:8px}#rotations .dph-head-actions .btn{border-radius:8px;font-weight:750;white-space:nowrap}#rotations .dph-list{display:flex;flex-wrap:wrap;gap:7px;padding:11px 13px}#rotations .dph-chip{display:inline-flex;align-items:center;gap:5px;border:1px solid #d6ded6;background:#fff;border-radius:999px;padding:6px 9px;font-size:var(--cb-text-xs);font-weight:750;color:#344054;text-decoration:none}#rotations .dph-chip:hover{border-color:#9eae9e;background:#f3f8f3;color:#172033}
      ...
      @media(max-width:575.98px){#player_development .season-dev-summary{align-items:flex-start}.practice-plan-details-form .reuse-practice-btn{width:100%;order:-1}#rotations .dph-head{align-items:flex-start;flex-direction:column}#rotations .dph-head-actions{width:100%;justify-content:space-between}#rotations .dph-head-actions .btn{min-height:40px;display:inline-flex;align-items:center;justify-content:center}#rotations .dph-list{padding:9px 10px}#rotations .rotation-template-toolbar{width:100%}#rotations .rotation-template-toolbar .btn{width:100%;min-height:42px;display:inline-flex;align-items:center;justify-content:center}}
    `;
