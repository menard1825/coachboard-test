(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      @media(max-width:575.98px){html body.cb-dugout #cbQuickDefense .cb-qd-head{padding:8px 9px 7px!important}html body.cb-dugout #cbQuickDefense .cb-qd-title{font-size:.9rem!important}html body.cb-dugout #cbQuickDefense .cb-qd-help{font-size:var(--cb-text-xs)!important}html body.cb-dugout #cbQuickDefense .cb-qd-body{padding:6px 7px 8px!important}html body.cb-dugout #cbQuickDefense .cb-qd-field{min-height:0!important;max-height:228px!important;aspect-ratio:1.58/1!important}html body.cb-dugout #cbQuickDefense .cb-qd-spot{width:61px!important}html body.cb-dugout #cbQuickDefense .cb-qd-name{font-size:.55rem!important;padding:3px 4px!important}html body.cb-dugout #cbQuickDefense .cb-qd-bench-wrap{margin-top:6px!important;padding:7px!important}html body.cb-dugout #cbQuickDefense .cb-qd-bench-player{padding:6px 7px!important;font-size:.66rem!important}html body.cb-dugout .coach-live-shell{padding-bottom:calc(96px + env(safe-area-inset-bottom))!important}body.cb-dugout #coach-action-slot.coach-actions{position:fixed;left:0;right:0;bottom:0;z-index:1030;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:9px!important;background:#eef1f4;border-top:1px solid #d7dde5;box-shadow:0 -6px 18px rgba(16,24,40,.12);padding:8px 10px calc(8px + env(safe-area-inset-bottom));margin:0!important}body.cb-dugout #coach-action-slot.coach-actions.cb-single-live-action{grid-template-columns:minmax(0,1fr)!important}body.cb-dugout #coach-action-slot.coach-actions.cb-single-live-action #liveEndInningBtn{width:100%!important}body.cb-dugout #liveChangePitcherBtn,body.cb-dugout #liveEndInningBtn{min-height:56px!important}}
