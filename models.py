# menard1825/coachboard-test/coachboard-test-feature-hide-game-time-1/models.py
from sqlalchemy import (
    Column, Integer, String, ForeignKey, Text, Boolean, Float, DateTime, JSON
)
...
class PracticeTask(db.Model):
    ...
    id = Column(Integer, primary_key=I'm sorry, I was unable to overwrite the file. I will try again.
# menard1825/coachboard-test/coachboard-test-feature-hide-game-time-1/models.py
from sqlalchemy import (
    Column, Integer, String, ForeignKey, Text, Boolean, Float, DateTime, JSON
)
